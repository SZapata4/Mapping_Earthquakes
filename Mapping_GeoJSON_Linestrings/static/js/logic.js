...
let torontoData = "https://raw.githubusercontent.com/SZapata4/Mapping_Earthquakes/main/torontoRoutes.json"
...
d3.json(torontoData).then(function(data) {
  ...
  L.geoJSON(data, {
    ...
    onEachFeature: function(feature, layer) {
      layer.bindPopup("<h2>" + "Airline: " + feature.properties.airline + "</h2> <hr> <h3>Population " + "Destination: " + feature.properties.dst + "</h3>")}})
  .addTo(map)
});
